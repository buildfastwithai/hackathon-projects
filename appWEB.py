...
if query:
    ...
    prompt_template = PromptTemplate(
        ...
        template=(
            ...
            "Your task is to assist users with their queries related to WEB DEVELOPMENT, applications, and recent advancements. "
            "You have access to relevant documents that provide detailed information about various WEB DEVELOPMENT topics, algorithms, and case studies.\n\n"
            "User Query: {query}\n\n"
            "{retrieved_documents}\n\n"
            "Your Response:\n"
            ...
            "- Ensure that the response is accessible to users with varying levels of knowledge about WEB DEVELOPMENT."
        )
    )
